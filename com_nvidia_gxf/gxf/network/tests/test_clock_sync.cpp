...
TEST(TestClockSync, PrimaryToSecondary) {
  ...
  ASSERT_EQ(GxfGraphLoadFile(context1, "gxf/network/tests/test_clock_sync_primary.yaml"),
            GXF_SUCCESS);
  ASSERT_EQ(GxfGraphLoadFile(context2,
            "gxf/network/tests/test_clock_sync_secondary.yaml"), GXF_SUCCESS);
