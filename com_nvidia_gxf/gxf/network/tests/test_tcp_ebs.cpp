...
TEST(TestTcp, TcpClientSocketEventBased) {
...
TEST(TestTcp, TcpServerSocketEventBased) {
...
TEST(TestTcp, ClientToServerEventBased) {
  ...
  ASSERT_EQ(GxfGraphLoadFile(context1, "gxf/network/tests/test_tcp_client_source_ebs.yaml"),
            GXF_SUCCESS);
  ASSERT_EQ(GxfGraphLoadFile(context2, "gxf/network/tests/test_tcp_server_sink_ebs.yaml"), GXF_SUCCESS);
...
TEST(TestTcp, ServerToClientEventBased) {
  gxf_context_t context1;
  ASSERT_EQ(GxfContextCreate(&context1), GXF_SUCCESS);
  ...
  ASSERT_EQ(GxfGraphLoadFile(context1, "gxf/network/tests/test_tcp_server_source_ebs.yaml"),
            GXF_SUCCESS);
  ASSERT_EQ(GxfGraphLoadFile(context2, "gxf/network/tests/test_tcp_client_sink_ebs.yaml"), GXF_SUCCESS);
...
TEST(TestTcp, ServerToClientAsyncEventBased) {
  gxf_context_t context1;
  ...
  ASSERT_EQ(GxfGraphLoadFile(context1, "gxf/network/tests/test_tcp_server_source_async_ebs.yaml"),
            GXF_SUCCESS);

  ASSERT_EQ(GxfGraphLoadFileExtended(context2, "gxf/network/tests/test_tcp_client_sink_async_ebs.yaml",
                                     "shared_ctx"),
            GXF_SUCCESS);
...
TEST(TestTcp, BidirectionalEventBased) {
  gxf_context_t context1;
  ASSERT_EQ(GxfContextCreate(&context1), GXF_SUCCESS);
  ...
  ASSERT_EQ(GxfGraphLoadFile(context1, "gxf/network/tests/test_tcp_client_bidirectional_ebs.yaml"),
            GXF_SUCCESS);
  ASSERT_EQ(GxfGraphLoadFile(context2, "gxf/network/tests/test_tcp_server_bidirectional_ebs.yaml"),
            GXF_SUCCESS);
...
TEST(TestTcp, ClientReconnectionEventBased) {
  gxf_context_t context1;
  gxf_context_t context2;
  ...
  ASSERT_EQ(GxfGraphLoadFile(context1, "gxf/network/tests/test_tcp_client_source_ebs.yaml"),
            GXF_SUCCESS);
  ASSERT_EQ(
      GxfGraphLoadFile(context2, "gxf/network/tests/test_tcp_client_reconnection_server_ebs.yaml"),
      GXF_SUCCESS);
  ...
  ASSERT_EQ(GxfGraphLoadFile(context3, "gxf/network/tests/test_tcp_client_source_ebs.yaml"),
            GXF_SUCCESS);
...
TEST(TestTcp, ServerReconnectionEventBased) {
  gxf_context_t context1;
  gxf_context_t context2;
  ...
  ASSERT_EQ(GxfGraphLoadFile(context1, "gxf/network/tests/test_tcp_server_source_ebs.yaml"),
            GXF_SUCCESS);
  ASSERT_EQ(
      GxfGraphLoadFile(context2, "gxf/network/tests/test_tcp_server_reconnection_client_ebs.yaml"),
      GXF_SUCCESS);
  ...
  ASSERT_EQ(GxfContextCreate(&context3), GXF_SUCCESS);
  ASSERT_EQ(GxfLoadExtensions(context3, &kExtensionInfo), GXF_SUCCESS);
  ASSERT_EQ(GxfGraphLoadFile(context3, "gxf/network/tests/test_tcp_server_source_ebs.yaml"),
            GXF_SUCCESS);
...
TEST(TestTcp, ServerReceiverPushEventBased) {
  gxf_context_t context1;
  gxf_context_t context2;
  ...
  ASSERT_EQ(
      GxfGraphLoadFile(context1, "gxf/network/tests/test_tcp_server_receiver_push_server_ebs.yaml"),
      GXF_SUCCESS);
  ASSERT_EQ(
      GxfGraphLoadFile(context2, "gxf/network/tests/test_tcp_server_receiver_push_client_ebs.yaml"),
      GXF_SUCCESS);
...
//TEST(TestTcp, ServerUnconnectedInterruptEventBased) {
...
//
//  ASSERT_EQ(
//      GxfGraphLoadFile(context, "gxf/network/tests/test_tcp_server_unconnected_interrupt_ebs.yaml"),
//      GXF_SUCCESS);
//
...
//}
//
//TEST(TestTcp, ClientUnconnectedInterruptEventBased) {
//  using namespace std::chrono_literals;
//  gxf_context_t context;
//  ASSERT_EQ(GxfContextCreate(&context), GXF_SUCCESS);
//
...
//
//  ASSERT_EQ(
//      GxfGraphLoadFile(context, "gxf/network/tests/test_tcp_client_unconnected_interrupt_ebs.yaml"),
//      GXF_SUCCESS);
//
//  ASSERT_EQ(GxfGraphActivate(context), GXF_SUCCESS);
//  ASSERT_EQ(GxfGraphRunAsync(context), GXF_SUCCESS);
