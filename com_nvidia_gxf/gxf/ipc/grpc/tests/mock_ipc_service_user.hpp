...
*/
#ifndef NVIDIA_GXF_HTTP_TESTS_MOCK_GRPC_SERVICE_HPP_
#define NVIDIA_GXF_HTTP_TESTS_MOCK_GRPC_SERVICE_HPP_
...
class MockIPCServiceUser : public Component {
 public:
...
class MockIPCClientUser : public Codelet {
 public:
  gxf_result_t registerInterface(Registrar* registrar) override;
...
#endif  // NVIDIA_GXF_HTTP_TESTS_MOCK_GRPC_SERVICE_HPP_
