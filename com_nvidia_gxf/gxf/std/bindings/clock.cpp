...
PYBIND11_MODULE(clock_pybind, m) {
  pybind11::class_<nvidia::gxf::Clock>(m, "Clock")
      ...
      .def("get", [](gxf_context_t context, gxf_uid_t cid, const char* name) {
          auto handle = getHandle<nvidia::gxf::Clock>(context, cid, name);
          if (!handle) {
  ...
  pybind11::class_<nvidia::gxf::RealtimeClock, nvidia::gxf::Clock>(m, "RealtimeClock");
  pybind11::class_<nvidia::gxf::ManualClock, nvidia::gxf::Clock>(m, "ManualClock");
}
