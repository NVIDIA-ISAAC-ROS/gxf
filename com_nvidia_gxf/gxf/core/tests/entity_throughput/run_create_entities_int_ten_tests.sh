...
LOGFILE="test_create_entities_int_ten.log"

# The array of thread numbers to be used
THREAD_NUMS=(1 2 4 8)

# Path to the .cpp file to modify
SOURCE_FILE="./test_create_entities_int_ten.cpp"
...
run_tests_for_thread_num() {
    ...
    do
        ...
        bazel run //gxf/core/tests/entity_throughput:test_entity_create_int_ten 2>&1 | tee -a $LOGFILE
    done
