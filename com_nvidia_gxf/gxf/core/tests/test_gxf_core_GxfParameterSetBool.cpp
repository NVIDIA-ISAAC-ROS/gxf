...
class GxfParameterSetBool_Test : public ::testing::Test {
 public:
  void SetUp() {
...
TEST_F(GxfParameterSetBool_Test, ValidParameter) {
  bool bool_var = true;
...
TEST_F(GxfParameterSetBool_Test, InvalidContext) {
  bool bool_var = true;
  GXF_ASSERT_EQ(GxfParameterSetBool(kNullContext, cid, "bool_var", bool_var),
                GXF_CONTEXT_INVALID);
}

TEST_F(GxfParameterSetBool_Test, OverwritingValidParameterType) {
...
TEST_F(GxfParameterSetBool_Test, OverwritingInvalidParameterType) {
  int64_t int64_var = 129;
  bool bool_var = true;
  GXF_ASSERT_SUCCESS(GxfParameterSetInt64(context, cid, "int64_var", int64_var));
  GXF_ASSERT_EQ(GxfParameterSetBool(context, cid, "int64_var", bool_var),
