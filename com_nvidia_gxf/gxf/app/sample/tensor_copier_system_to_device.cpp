...
class SystemToDeviceApp : public Application {
 public:
  void compose() override {
    ...
    // create an entity to copy messages from system to device
    ...
    // add data flow connection system -> device
...
TEST(TestApp, SystemToDeviceApp) {
  auto app = create_app<SystemToDeviceApp>();
