...
class HostToSystemApp : public Application {
 public:
  void compose() override {
    ...
    // create an entity to copy messages from host to system
    ...
    // add data flow connection host -> system
...
TEST(TestApp, HostToSystemApp) {
  auto app = create_app<HostToSystemApp>();
