...
APP_YAML = "gxf/python/tests/test_tensor_description.yaml"
MANIFEST_YAML = "gxf/python/tests/test_tensor_description_manifest.yaml"


class TestTensorDescription(unittest.TestCase):
    '''
