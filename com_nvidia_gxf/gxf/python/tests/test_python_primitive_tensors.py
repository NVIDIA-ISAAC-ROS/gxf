...
APP_YAML = "gxf/python/tests/test_python_primitive_tensors.yaml"
MANIFEST_YAML = "gxf/python/tests/test_python_primitive_tensors_manifest.yaml"


class TestPythonPrimitiveTensors(unittest.TestCase):
    '''
    Test tensor description API
    '''
    @classmethod
    def setUpClass(cls):
