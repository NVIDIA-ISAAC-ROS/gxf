...
struct ParameterWrapper<test::CompareTimestamp> {
  static Expected<YAML::Node> Wrap(gxf_context_t context, const test::CompareTimestamp& value) {
    YAML::Node node(YAML::NodeType::Scalar);
    switch (value) {
      case test::CompareTimestamp::kPubtimeOnly: {
        node = std::string("PubtimeOnly");
        break;
      }
      case test::CompareTimestamp::kAcqtimeOnly: {
        node = std::string("AcqtimeOnly");
        break;
      }
      case test::CompareTimestamp::kPubtimeAndAcqtime: {
        node = std::string("PubtimeAndAcqtime");
        break;
      }
      case test::CompareTimestamp::kNone: {
        node = std::string("None");
        break;
      }
      default:
