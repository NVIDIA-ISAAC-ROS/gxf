...
cc_library(
    ...
    srcs = [
        ...
        "ucx-install-with-cuda/usr/lib/ucx/libucm_cuda.so",
        "ucx-install-with-cuda/usr/lib/ucx/libucm_cuda.so.0",
        "ucx-install-with-cuda/usr/lib/ucx/libucm_cuda.so.0.0.0",
        "ucx-install-with-cuda/usr/lib/ucx/libuct_cma.so",
        "ucx-install-with-cuda/usr/lib/ucx/libuct_cma.so.0",
        "ucx-install-with-cuda/usr/lib/ucx/libuct_cma.so.0.0.0",
        "ucx-install-with-cuda/usr/lib/ucx/libuct_cuda.so",
        "ucx-install-with-cuda/usr/lib/ucx/libuct_cuda.so.0",
        "ucx-install-with-cuda/usr/lib/ucx/libuct_cuda.so.0.0.0",
        "ucx-install-with-cuda/usr/lib/ucx/libuct_ib.so",
        "ucx-install-with-cuda/usr/lib/ucx/libuct_ib.so.0",
        "ucx-install-with-cuda/usr/lib/ucx/libuct_ib.so.0.0.0",
        "ucx-install-with-cuda/usr/lib/ucx/libuct_rdmacm.so",
        "ucx-install-with-cuda/usr/lib/ucx/libuct_rdmacm.so.0",
        "ucx-install-with-cuda/usr/lib/ucx/libuct_rdmacm.so.0.0.0",
        # "ucx-install-with-cuda/usr/lib/ucx/libucx_perftest_cuda.so",
        # "ucx-install-with-cuda/usr/lib/ucx/libucx_perftest_cuda.so.0",
        # "ucx-install-with-cuda/usr/lib/ucx/libucx_perftest_cuda.so.0.0.0",
    ],
    hdrs = [
