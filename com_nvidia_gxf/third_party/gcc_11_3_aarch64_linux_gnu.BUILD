...
# GNU GCC 11.3.0 cross aarch64 compiler

filegroup(
    name = "gcc_11_3_aarch64_linux_gnu",
    srcs = glob([
        "bin/*",
        "aarch64-buildroot-linux-gnu/include/c++/11.3.0/**/*",
        "aarch64-buildroot-linux-gnu/sysroot/usr/include/**/*",
        "lib/gcc/aarch64-buildroot-linux-gnu/11.3.0/include/**/*",
        "lib/gcc/aarch64-buildroot-linux-gnu/11.3.0/include-fixed/**/*",
