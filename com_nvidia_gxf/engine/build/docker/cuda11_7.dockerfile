...
# Install cupy 10.6 cuda 11.7 from whl file
RUN apt update && \
    pip3 install "https://files.pythonhosted.org/packages/f3/74/590d91952e0cea9c58b91095a2eab8ae466a60a667069eb9e18448176d5e/cupy_cuda117-10.6.0-cp38-cp38-manylinux1_x86_64.whl"

# Set cache dir in /tmp/ since we dont have access to {$HOME} in CI
ENV CUPY_CACHE_DIR /tmp/cupy_cuda_11_7/
